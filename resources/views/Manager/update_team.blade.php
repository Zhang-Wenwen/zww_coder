        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="{{url('/manager/update/team')}}{{'/'.$team->id}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-group">
                                    <h1> 基本信息</h1>
                                    <label class="control-label" for="inputSuccess">输入姓名</label>
                                    <input type="text" class="form-control" id="inputSuccess" name="name" value="{{$team->name}}">
                                    <div class="form-group has-warning">
                                        <label class="control-label" for="inputWarning">当下工作</label>
                                        <input type="text" class="form-control" id="inputWarning" name="now" value="{{$team->now}}">
                                    </div>
                                    <div class="form-group has-error">
                                        <label class="control-label" for="inputError">所属组别</label>
                                        <input type="text" class="form-control" id="inputError" name="group" value="{{$team->group}}">
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>学长寄语</label>
                                    <textarea class="form-control" name="text" rows="3" >{{$team->text}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>选择类型</label>
                                    <div class="radio">
