...
<div class="admin-content">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">页面显示</strong></div>
    </div>
    设置成功    <div class="am-tabs am-margin" data-am-tabs>
        ...
        <div class="am-tabs-bd">
            ...
            <div class="am-tab-panel am-fade" id="tab3">
                <form class="am-form" action="http://coder.twtstudio.com/admin.php/Home/Team/show_save" method="post">
                    <div class="am-g am-margin-top-sm">
                        <div class="am-u-sm-4 am-u-md-2 am-text-right">
                            每页显示成员数
                        </div>
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            <input type="text" name="new_num" value="10" class="am-input-sm">
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            <input name="new_grade" value="2012-2013-2014-2015" style="width:305px"
                                   class="am-input-sm">
                        </div>
                        <p class="am-form-help">请输入年级，用 - 隔开，如2012-2013-2014</p>
                    </div>

                    <div class="am-margin">
                        <input type="submit" class="am-btn am-btn-primary am-btn-xs" value="修改">
