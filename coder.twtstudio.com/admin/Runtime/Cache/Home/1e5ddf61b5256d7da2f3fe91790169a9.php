...
<div class="admin-content">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">关于我们</strong></div>
    </div>
    <?php echo ($state); ?>
    <div class="am-tabs am-margin" data-am-tabs>
        ...
        <div class="am-tabs-bd">
            ...
            <div class="am-tab-panel am-fade" id="tab3">
                <form class="am-form" action="http://coder.twtstudio.com/admin.php/Home/About/about_save" method="post">
                    <div class="am-g am-margin-top-sm">
                        <div class="am-u-sm-4 am-u-md-2 am-text-right">
                           第一列
                        </div>
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            <textarea name="first"   style="width: 450px; height: 200px;" >
                                <?php echo ($first_col); ?>
                            </textarea>
                        </div>
                    </div>
                     ...
                     <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            <textarea name="sec"   style="width: 450px; height: 200px;"  >
                                <?php echo ($sec_col); ?>
                            </textarea>
                        </div>
                    </div>
                     <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            <textarea name="third"   style="width: 450px; height: 200px;"  >
                                <?php echo ($third_col); ?>
                            </textarea>
                        </div>
                    </div>
