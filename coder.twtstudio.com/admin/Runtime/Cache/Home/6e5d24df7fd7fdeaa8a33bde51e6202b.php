    ...
    <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
            ...
            <form class="am-form am-form-horizontal"
                  action="<?php echo teamAdminHtml_path ?>saveinfo?teamer_id=<?php echo ($ele["0"]["id"]); ?>&grade=<?php echo ($ele["0"]["teamer_grade"]); ?>"
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_name" value="<?php echo ($ele["0"]["teamer_name"]); ?>">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_group" value="<?php echo ($ele["0"]["teamer_group"]); ?>">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_school" value="<?php echo ($ele["0"]["teamer_school"]); ?>">
                 ...
                 <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_go" value="<?php echo ($ele["0"]["teamer_go"]); ?>">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_mainpage_link" value="<?php echo ($ele["0"]["teamer_mainpage_link"]); ?>">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_grade" value="<?php echo ($ele["0"]["teamer_grade"]); ?>">
...
<script src="<?php echo crop_path ; ?>js/jquery.Jcrop.min.js"></script>
<script src="<?php echo crop_path ; ?>js/script.js"></script>
