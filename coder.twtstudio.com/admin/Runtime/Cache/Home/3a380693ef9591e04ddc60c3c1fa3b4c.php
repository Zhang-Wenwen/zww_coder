    ...
    $list.sortable({
        ...
        update: function () {
            ...
            $.ajax(
                    {
                        type: "post",
                        url: "<?php echo U('Index/sort');?>",//服务器端处理程序
...
<div id="admin-content">
    ...
    <div id="loader"></div>
    <form action="<?php echo U('Index/sort');?>" method='post' enctype="multipart/form-data">
        ...
        <div id="module_list">
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="modules" title="<?php echo ($data["id"]); ?>">
                    <h3 class="m_title" style="cursor: move;"><?php echo ($data["pic_name"]); ?></h3>
