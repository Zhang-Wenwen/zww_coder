    ...
    <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
            ...
            <form class="am-form am-form-horizontal"
                  action="http://coder.twtstudio.com/admin.php/Home/Team/saveinfo?teamer_id=147&grade=2015"
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_name" value=" 谢娟">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_group" value="产品组">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        ...
                        <input type="text" name="teamer_school" value="软件学院">
