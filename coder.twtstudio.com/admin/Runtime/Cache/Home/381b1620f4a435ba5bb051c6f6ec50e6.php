            ...
            <form class="am-form">
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <tr>
                            ...
                            <td class="am-hide-sm-only">产品组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14643497820370.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=147&grade=2015">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=147&grade=2015">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only">程序组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14644407640780.png.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=152&grade=2015">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=152&grade=2015">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
