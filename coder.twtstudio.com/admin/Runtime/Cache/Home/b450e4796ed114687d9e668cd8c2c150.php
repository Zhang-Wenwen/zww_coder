...
<div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加成员</strong> </div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="<?php echo teamAdminHtml_path ?>getele2" method="post" enctype="multipart/form-data" id="upload_form" onsubmit="return checkForm()">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 </label>
            <div class="am-u-sm-9">
              <input type="text"  name="teamer_name">
          ...
          <div class="am-form-group">
           <label class="am-u-sm-3 am-form-label"> 年级</label>
            <div class="am-u-sm-9">
              <input type="text" name="teamer_grade">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="teamer_group">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="teamer_school">
            </div>
          </div>
           ...
           <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="teamer_go">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
            <input type="text" name="teamer_mainpage_link">
            </div>
          </div>
          ...
          <div class="am-form-group">
                 ...
                 <label  class="am-u-sm-3 am-form-label">上传头像</label>
                  <div class="am-u-sm-9">
