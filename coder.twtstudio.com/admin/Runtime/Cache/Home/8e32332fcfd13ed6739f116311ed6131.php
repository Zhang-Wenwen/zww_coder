        ...
        <div class="am-u-sm-12 am-u-md-6">
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                    <?php $__FOR_START_1985405205__=0;$__FOR_END_1985405205__=$cnt;for($i=$__FOR_START_1985405205__;$i < $__FOR_END_1985405205__;$i+=1){ ?><button type="button" class="am-btn am-btn-default"><a
                                href="<?php echo teamAdminHtml_path ?>member_table?grade=<?php echo ($all_grade[$i]['teamer_grade']); ?>">
                            <?php echo ($all_grade[$i]['teamer_grade']); ?></a></button><?php } ?>
                </div>
            </div>
        </div>
            ...
            <form class="am-form">
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$obj): ?><tr>
                            ...
                            <td><?php echo ($obj["teamer_name"]); ?></td>
                            <td><?php echo ($obj["teamer_school"]); ?></a></td>
                            <td><?php echo ($obj["teamer_grade"]); ?></td>
                             <td><?php echo ($obj["teamer_go"]); ?></td>
                            <td class="am-hide-sm-only"><?php echo ($obj["teamer_group"]); ?></td>
                            <td class="am-hide-sm-only"><a
                                    href="<?php echo teamAdminHtml_path ?>see_photo?photo_loc=<?php echo ($obj["teamer_photo_loc"]); ?>">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                ...
                                                href="<?php echo teamAdminHtml_path ?>updateinfo?teamer_id=<?php echo ($obj["id"]); ?>&grade=<?php echo ($obj["teamer_grade"]); ?>">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="<?php echo teamAdminHtml_path ?>dinfo?teamer_id=<?php echo ($obj["id"]); ?>&grade=<?php echo ($obj["teamer_grade"]); ?>">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
