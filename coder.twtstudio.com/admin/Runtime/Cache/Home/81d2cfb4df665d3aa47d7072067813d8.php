...
<div class="am-cf am-padding">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" action="http://coder.twtstudio.com/admin.php/Home/Team/getele2" method="post" enctype="multipart/form-data" id="upload_form" onsubmit="return checkForm()">
