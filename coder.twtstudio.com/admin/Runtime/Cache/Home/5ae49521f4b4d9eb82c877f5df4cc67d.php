...
<div class="admin-content">
    <legend>编辑轮播</legend>
    <table class="am-table am-table-bordered" border='1' width="800" align='center'>
        <thead>
        <tr>
            <th>轮播名称</th>
            <th>轮播链接</th>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href="<?php echo ($vo["pic_link"]); ?>"><?php echo ($vo["pic_link"]); ?></a></td>
                <td><a href="http://coder.twtstudio.com/Public<?php echo ($vo["pic_loc"]); ?>">查看图片</a></td>
                <td>
                <?php if($vo["pic_isshow"] == 1): ?>是
                    <?php else: ?> 否<?php endif; ?>
                </td>
                <td><?php echo ($vo["pic_showid"]); ?></td>
                <td><a href="/admin.php/Home/Index/del/id/<?php echo ($vo["id"]); ?>">删除</a> | <a
                        href="/admin.php/Home/Index/modifypic/id/<?php echo ($vo["id"]); ?>">修改</a>|
                    <?php if($vo["pic_isshow"] == 1): ?><a href="/admin.php/Home/Index/hide/id/<?php echo ($vo["id"]); ?>">隐藏</a>
                    <?php else: ?>  <a href="/admin.php/Home/Index/show/id/<?php echo ($vo["id"]); ?>">显示</a><?php endif; ?>|
                    </td>
