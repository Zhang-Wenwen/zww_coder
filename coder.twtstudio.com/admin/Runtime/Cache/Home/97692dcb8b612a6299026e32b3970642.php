                ...
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <tr>
                            ...
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14584734420780.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                ...
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=109&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=109&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only">程序组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14584736050254.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=110&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=110&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14584736880154.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=111&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=111&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only">程序组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14584746520804.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=113&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=113&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only">程序组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14584760280145.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=116&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=116&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only">程序组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14584764280830.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=119&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=119&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>2014</td>
                             <td></td>
                            <td class="am-hide-sm-only">移动组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14594900930453.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=121&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=121&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only">移动组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14594901510025.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=122&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=122&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only">设计组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14611448630170.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=124&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=124&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="am-hide-sm-only">设计组</td>
                            <td class="am-hide-sm-only"><a
                                    href="http://coder.twtstudio.com/admin.php/Home/Team/see_photo?photo_loc=14613976940416.jpg.'b'">查看
                            </td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                class="am-icon-pencil-square-o"></span> <a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/updateinfo?teamer_id=125&grade=2014">编辑</a>
                                        </button>

                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span><a
                                                href="http://coder.twtstudio.com/admin.php/Home/Team/dinfo?teamer_id=125&grade=2014">
                                            删除</a></button>
                                    </div>
                                </div>
                            </td>
