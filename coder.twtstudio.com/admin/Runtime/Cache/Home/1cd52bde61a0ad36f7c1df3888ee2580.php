    ...
    <div class="am-tabs am-margin" data-am-tabs>
        ...
        <div class="am-tabs-bd">
            ...
            <div class="am-tab-panel am-fade" id="tab3">
                <form class="am-form" action="<?php echo teamAdminHtml_path ?>show_save" method="post">
                    <div class="am-g am-margin-top-sm">
                        <div class="am-u-sm-4 am-u-md-2 am-text-right">
                            每页显示成员数
                        </div>
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            <input type="text" name="new_num" value="<?php echo ($show_how["show_num"]); ?>" class="am-input-sm">
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top-sm">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end">
                            <input name="new_grade" value="<?php echo ($show_how["show_grade"]); ?>" style="width:305px"
                                   class="am-input-sm">
                        </div>
