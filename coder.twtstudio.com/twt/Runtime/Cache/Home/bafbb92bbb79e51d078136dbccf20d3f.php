...
box-shadow:0 0 3px #ccc;">
            ...
            <tr class="button">
                ...
                <td style="text-align:right ; left:50px;">
                    ...
                    <div> <img src='http://coder.twtstudio.com/Public/Images/Frontend/prev.png'>  <a class="next" href="/index.php/home/team_index/showinfo2/teamer_group/%28SELECT+%28CASE+WHEN+%28ISNULL%28TIMESTAMPADD%28MINUTE%2C6148%2CNULL%29%29%29+THEN+6148+ELSE+6148%2A%28SELECT+6148+FROM+INFORMATION_SCHEMA.CHARACTER_SETS%29+END%29%29/p/2.html"><img src='http://coder.twtstudio.com/Public/Images/Frontend/next.png'></a> </div>                </td>
