...
box-shadow:0 0 3px #ccc;">
            ...
            <tr class="button">
                ...
                <td style="text-align:right ; left:50px;">
                    ...
                    <div> <img src='http://coder.twtstudio.com/Public/Images/Frontend/prev.png'>  <a class="next" href="/index.php/home/team_index/showinfo2/teamer_group/%28SELECT+%28CASE+WHEN+%283699%3D%28SELECT+3699+FROM+information_schema.GLOBAL_STATUS+LIMIT+0%2C+1%29%29+THEN+3699+ELSE+3699%2A%28SELECT+3699+FROM+INFORMATION_SCHEMA.CHARACTER_SETS%29+END%29%29/p/2.html"><img src='http://coder.twtstudio.com/Public/Images/Frontend/next.png'></a> </div>                </td>
