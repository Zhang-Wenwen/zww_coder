...
box-shadow:0 0 3px #ccc;">
            ...
            <tr class="button">
                ...
                <td style="text-align:right ; left:50px;">
                    ...
                    <div> <img src='http://coder.twtstudio.com/Public/Images/Frontend/prev.png'>  <a class="next" href="/index.php/home/team_index/showinfo2/teamer_group/%28SELECT+%28CASE+WHEN+%2848%3D48%29+THEN+3794+ELSE+3794%2A%28SELECT+3794+FROM+INFORMATION_SCHEMA.CHARACTER_SETS%29+END%29%29/p/2.html"><img src='http://coder.twtstudio.com/Public/Images/Frontend/next.png'></a> </div>                </td>
